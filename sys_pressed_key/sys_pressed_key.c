...
MODULE_LICENSE("GPL");
static int irq = 1, dev_keyboard = 0xaa, counter = 0;
/*Ze*/
...
/*Ze fim*/
static irqreturn_t keyboard_handler(int irq, void *dev_keyboard)
{
	increment();
	return IRQ_NONE;
}
...
{
	pr_info("%s: In init\n", __func__);
	int res = request_irq(28, keyboard_handler, IRQF_SHARED, "my_keyboard_handler", &dev_keyboard);
	pr_info("\n\n res = %d \n\n", res);
